/*
 * JUnit test case for bean Jjjkkk
...
public class JjjkkkTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class Jjjkkk getters and setters ..." );
		
		Jjjkkk jjjkkk = new Jjjkkk();
		
		//--- Test setter/getter for field "hello"  ( type : Integer )
		// System.out.println(" checking field hello ..." );
		jjjkkk.setHello( integerValue ) ;
		Assert.assertTrue( integerValue == jjjkkk.getHello() ) ;

		//--- Test setter/getter for field "myfield"  ( type : String )
		// System.out.println(" checking field myfield ..." );
		jjjkkk.setMyfield( stringValue ) ;
		Assert.assertTrue( stringValue.equals( jjjkkk.getMyfield() ) ) ;
