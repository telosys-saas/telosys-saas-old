...
public class KkkkTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class Kkkk getters and setters ..." );
		
		Kkkk kkkk = new Kkkk();
		
		//--- Test setter/getter for field "myfield"  ( type : String )
		// System.out.println(" checking field myfield ..." );
		kkkk.setMyfield( stringValue ) ;
		Assert.assertTrue( stringValue.equals( kkkk.getMyfield() ) ) ;
